...
const DevDraft: React.FC<DevDraftProps> = ({ setActiveTool, onToggleCommandPalette, projects, onRenameProject, onDeleteProject, onAddProject, onUpdateProject, loadedProject, onProjectLoaded, customApiKey, theme, setTheme, isSidebarCollapsed, setIsSidebarCollapsed, onOpenSettings }) => {
